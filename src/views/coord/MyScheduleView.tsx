...
export default function MyScheduleView({
  ...
  // Show all courses - not just coordinated
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        <div className="space-y-3 max-w-3xl">
          ...
          <div className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-2 flex items-center gap-2 text-[10px] text-zinc-500 font-medium">
            <span className="font-black text-zinc-700 shrink-0">Como funciona a matriz acadêmica?</span>
            <span className="truncate">Grade preenchida e homologada pelos coordenadores. Somente consulta — sem modificação direta.</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap self-start">
          ...
          <div className="flex items-center gap-2.5 bg-white border border-zinc-200 px-4 py-2.5 rounded-2xl shadow-xs">
        ...
        <div className="overflow-x-auto border border-zinc-200/50 rounded-[1.8rem] shadow-inner bg-zinc-50">
          <table className="w-full min-w-[850px] border-collapse bg-white">
            ...
            <tbody className="divide-y divide-zinc-100">
              {DISPLAY_TIME_SLOTS.filter(slot => {
