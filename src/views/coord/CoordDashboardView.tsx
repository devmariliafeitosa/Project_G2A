    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-20">
      <header className="flex justify-between items-start">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">Tempo Real • Campus Tauá</span>
          </div>
          <h1 className="text-2xl font-semibold text-zinc-900 tracking-tight leading-none mb-1.5">Visão Geral do Curso</h1>
          <p className="text-zinc-500 text-sm font-medium">Indicadores cruciais para a coordenação neste semestre.</p>
        </div>
        <div className="flex flex-col items-end gap-2">
          <button 
            ...
            className="text-[9px] bg-amber-50 uppercase tracking-widest border border-amber-200 text-amber-700 font-black px-3 py-1.5 rounded-lg active:scale-95 transition-all shadow-sm shadow-amber-500/5 hover:bg-amber-100"
          >
      ...
      <div className="bg-white rounded-[3rem] border border-zinc-100 shadow-xl shadow-zinc-100/10 overflow-hidden">
        <div className="p-8 border-b border-zinc-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-zinc-50/30">
          ...
          <div className="flex items-center gap-3">
            <label className="text-[10px] font-black uppercase text-zinc-400 tracking-widest">Semestre Letivo:</label>
            <select
              value={selectedSemester}
              onChange={(e) => setSelectedSemester(e.target.value)}
              className="h-11 px-4 bg-white border border-zinc-200 rounded-xl text-xs font-black uppercase tracking-widest outline-none focus:border-[#32a041]/30 text-zinc-700 shadow-sm animate-pulse"
            >
        ...
        {showAddModal && (
          <div className="fixed inset-0 bg-zinc-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-6">
            <motion.div 
              ...
              className="bg-white rounded-[2.5rem] max-w-lg w-full overflow-hidden shadow-2xl border border-zinc-100 flex flex-col"
            >

              <div className="p-8 border-b border-zinc-100 bg-[#32a041]/5 flex justify-between items-center">
                <div>
              ...
              <div className="p-8 border-t border-zinc-100 bg-zinc-50 flex items-center justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setShowAddModal(false)}
